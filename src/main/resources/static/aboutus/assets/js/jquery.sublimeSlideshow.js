( function( $ ){
    ...
    var $backgrounds = $( "<ul class='sm-slider'></ul>" ),
        ...
        init : function( settings ) {
            ...
            $backgrounds.html(this.mkhtml( options.src )).prependTo("#aboutusShow");
        ...
        mkcss: function( bgCount , duration , fade  )
        {
            ...
            {
                var bg = src[i];
                css += ".sm-slider li:nth-child({0}) span { background-image: url('{1}');animation-delay: {2}s; } .slider li:nth-child({0}) div { animation-delay: {2}s; }".format(i+1 , bg.url, duration*i );
